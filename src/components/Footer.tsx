...
const Footer: React.FC = () => {
  return (
    <footer className="bg-noir-dark text-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="text-sm font-medium uppercase tracking-wider text-noir-gold mb-4">Quick Links</h4>
            <ul className="space-y-2">
              {['Home', 'About', 'Gallery', 'Location', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
                    href={`#${item.toLowerCase()}`}
                    className="text-sm text-gray-300 hover:text-noir-gold transition-colors"
                  >
                    {item}
                  </a>
                </li>
        ...
        <div className="border-t border-noir-light mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <ul className="flex space-x-6 text-xs text-gray-500">
              <li><a href="#" className="hover:text-noir-gold transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="hover:text-noir-gold transition-colors">Terms & Conditions</a></li>
              <li><a href="#" className="hover:text-noir-gold transition-colors">Disclaimer</a></li>
            </ul>
          </div>
        </div>
      </div>
